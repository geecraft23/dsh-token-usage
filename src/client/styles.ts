...
.dsh-usage .calendar .day{aspect-ratio:1;min-width:0;border:0;border-radius:30%;padding:0;width:100%;background:var(--day-fill);transition:filter .15s,transform .15s}.dsh-usage .day[aria-pressed=true]{outline:2px solid #789ce080;outline-offset:2px}
.dsh-usage .level-0{--day-fill:#e8eaee}.dsh-usage .level-1{--day-fill:#d7e1f5}.dsh-usage .level-2{--day-fill:#afc4ed}.dsh-usage .level-3{--day-fill:#7c9edf}.dsh-usage .level-4{--day-fill:#2d68cc}.dsh-usage .calendar .day:hover{filter:brightness(.97);transform:translateY(-1px)}
.dsh-usage .heat-legend{display:flex;align-items:center;justify-content:flex-end;gap:4px;margin-top:10px;font-size:10px;opacity:.65}.dsh-usage .heat-legend i{width:10px;height:10px;border-radius:30%;border:0;background:var(--day-fill)}
