...
.dsh-usage .level-0{--day-fill:#f4f4f5}.dsh-usage .level-1{--day-fill:#d7e1f5}.dsh-usage .level-2{--day-fill:#afc4ed}.dsh-usage .level-3{--day-fill:#7c9edf}.dsh-usage .level-4{--day-fill:#2d68cc}.dsh-usage .calendar .day:hover{filter:brightness(.97);transform:translateY(-1px)}
