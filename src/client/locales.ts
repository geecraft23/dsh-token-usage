...
export const en = {
  ...
  heatHint: 'One square per day. White means no recorded requests; darker colors mean more tokens relative to the peak in this selection. Defaults to 90 days; choose 30 days for a shorter view. All-time and custom calendars show at most 366 days. Dates before tracking began have no records.',
...
export const zh: Record<keyof typeof en, string> = {
  ...
  heatHint: '每格代表一天。白色表示没有请求记录，颜色按所选范围的最高用量分级加深。默认近 90 天，也可切换近 30 天；全部时间和自选日期最多展示 366 天。启用前的日期没有记录。',
